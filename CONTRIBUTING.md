...
When filing an issue, please check [existing open](https://github.com/aws/aws-dotnet-extensions-configuration/issues), or [recently closed](https://github.com/aws/aws-dotnet-extensions-configuration/issues?utf8=%E2%9C%93&q=is%3Aissue%20is%3Aclosed%20), issues to make sure somebody else hasn't already 
...
```
autover change --project-name "Amazon.Extensions.Configuration.SystemsManager" -m "Fixed an issue causing a failure somewhere
```
